...
(define-key global-map (kbd "M-<left>") 'awesome-tab-backward-tab)
(define-key global-map (kbd "M-<right>") 'awesome-tab-forward-tab)
(define-key global-map (kbd "M-\\") 'awesome-tab-kill-other-buffers-in-current-group)
